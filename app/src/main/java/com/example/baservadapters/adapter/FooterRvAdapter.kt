...
class FooterRvAdapter : BaseHeadOrFooterRvAdapter<ItemButtonBinding, String>() {
    override val type: HeaderOrFooterRVType
        get() = HeaderOrFooterRVType.Footer
    ...
    override fun createHolder(binding: ItemButtonBinding, viewHolder: RecyclerView.ViewHolder) {
        binding.btn.backgroundTintList = ColorStateList.valueOf(ContextCompat.getColor(context, android.R.color.holo_purple))
    }
