...
class HeaderRvAdapter : BaseHeadOrFooterRvAdapter<ItemButtonBinding, String>() {
    override val type: HeaderOrFooterRVType
        get() = HeaderOrFooterRVType.Header
    ...
    override fun createHolder(binding: ItemButtonBinding, viewHolder: RecyclerView.ViewHolder) {
        binding.btn.backgroundTintList = ColorStateList.valueOf(ContextCompat.getColor(context, android.R.color.holo_orange_dark))
    }
